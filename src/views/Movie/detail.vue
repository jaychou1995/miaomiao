		...
		mounted() {
			...
			this.axios.get('/api/detailmovie?movieId='+ this.movieId).then((res)=>{
				if( res.data.msg === 'ok' ){
					...
					this.$nextTick(()=>{
					    // new Scroller(this.$refs.detail_player , {
					    //     slidesPerView : 'auto',
					    //     freeMode : true,
					    //     freeModeSticky: true
					    // });
...
<style scoped>
	...
	#content .detail_player{ margin:20px;height: 120px; overflow-x: scroll;}
	.detail_player .swiper-slide{ width:140px!important; height: 120px!important; margin-right: 20px; text-align: center; font-size: 14px;display: inline-block;}
